  ...
  return (
    ...
    >
      ...
      <div className="mt-6 lg:mt-8 w-full">
        <Link
          href="/gallery"
          className="group relative w-full bg-white/70 backdrop-blur-xl rounded-[2rem] md:rounded-[2.5rem] border border-white/50 p-8 md:p-12 lg:p-16 flex flex-col md:flex-row items-start md:items-center justify-between overflow-hidden shadow-[0_8px_30px_rgba(116,12,8,0.02)] hover:shadow-[0_40px_80px_rgba(116,12,8,0.08)] hover:-translate-y-1.5 transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-mace-gold)] focus-visible:ring-offset-2"
        >
          {/* Subtle Background Flare */}
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_100%_100%,var(--color-mace-gold),transparent_50%)] opacity-0 group-hover:opacity-[0.08] transition-opacity duration-1000 pointer-events-none" />
          
          <div className="flex flex-col md:flex-row md:items-center gap-6 lg:gap-8 relative z-10 w-full">
            {/* Icon Block */}
            <div className="w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 rounded-2xl md:rounded-[1.75rem] bg-white/80 border border-[var(--border)] flex items-center justify-center shrink-0 group-hover:bg-[var(--color-mace-gold)] group-hover:border-[var(--color-mace-gold)] group-hover:shadow-[0_0_40px_rgba(245,158,11,0.3)] transition-all duration-700 shadow-sm group-hover:scale-105">
              <Film className="h-8 w-8 md:h-10 md:w-10 lg:h-12 lg:w-12 text-[var(--color-mace-gold)] group-hover:text-white transition-colors duration-500" strokeWidth={1.5} aria-hidden="true" />
            </div>

            {/* Text Block */}
            <div className="mt-2 md:mt-0 transition-transform duration-700 group-hover:translate-x-3">
              <div className="mb-2 flex flex-wrap items-center gap-3 md:gap-4">
                <h3 className="font-serif text-3xl md:text-4xl lg:text-5xl font-medium tracking-tight text-[var(--color-mace-crimson)]">
                ...
                <div className="px-3 py-1.5 rounded-full border border-[var(--color-mace-gold)]/30 bg-[var(--color-mace-gold)]/10 text-[10px] md:text-[11px] font-bold uppercase tracking-[0.2em] text-[var(--color-mace-gold)] whitespace-nowrap">
                  Master Gallery
                </div>
              </div>
          ...
          {/* CTA Arrow */}
          <div className="mt-8 md:mt-0 flex items-center gap-4 text-[12px] font-black uppercase tracking-[0.3em] text-[var(--text-muted)] group-hover:text-[var(--color-mace-gold)] transition-colors duration-500 relative z-10 shrink-0">
            <span className="hidden lg:block group-hover:-translate-x-2 transition-transform duration-500">Enter Vault</span>
            <div className="w-12 h-12 md:w-14 md:h-14 rounded-full bg-[var(--surface-soft)] border border-[var(--border)] flex items-center justify-center group-hover:bg-[var(--color-mace-gold)]/10 group-hover:border-[var(--color-mace-gold)]/30 transition-all duration-500 group-hover:scale-110">
              <ArrowUpRight className="h-6 w-6 text-[var(--color-mace-crimson)] group-hover:text-[var(--color-mace-gold)] transition-colors duration-500" strokeWidth={1.5} aria-hidden="true" />
            </div>
          </div>
        </Link>
      </div>
